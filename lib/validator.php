...
/**
 * This class is meant to be a flexible user-input validation object.
 * 
 * It can be instantiated and used temporarily or extended in order to add
 * input validation to your objects.
 * 
...
class Validator {
	...
	public function isString() {
		$string_validationPattern = "/^[a-z0-9, \n\r\t\.<>_\-'\";:\/\\\[\]\{\}\^\$\(\)\?\*\+&%#@!`\~]+$/i";
